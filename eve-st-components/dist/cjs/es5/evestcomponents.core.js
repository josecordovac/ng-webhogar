...
function r(n, t, e) { void 0 === e && (e = {}); var r = Array.isArray(t) ? t : [t], i = n.document, o = e.hydratedCssClass || "hydrated", u = e.exclude; u && (r = r.filter(function (n) { return -1 === u.indexOf(n[0]); })); var c = r.map(function (n) { return n[0]; }); if (c.length > 0) {
...
} var s = e.namespace || "evestcomponents"; return H || (H = !0, function l(n, t, e) { (n["s-apps"] = n["s-apps"] || []).push(t), e.componentOnReady || (e.componentOnReady = function t() { function e(t) { if (r.nodeName.indexOf("-") > 0) {
    ...
    evestcomponents_global_js_1.default(s, u, n, i, c, o), F[s] = D(s, u, n, i, c, o, r);
...
var evestcomponents_global_js_1 = require("./evestcomponents.global.js");
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    var a = w(r), s = w(i), l = a.filter(function (n) { return !s.includes(n); }), v = w(t.className).filter(function (n) { return !l.includes(n); }), d = s.filter(function (n) { return !a.includes(n) && !v.includes(n); });
    ...
    } })(n, this); }, e["s-init"] = function () { (function (n, t, e, r, i, o) { if (R(n, t) && n.gn.get(t) && !n.mn.has(t) && (!t["s-ld"] || !t["s-ld"].length)) {
        n.ct.set(t, !0), n.vt.has(t) || (n.vt.set(t, !0), t["s-ld"] = void 0, n.Z.En(t, e));
        try {
            j(n.On.get(t)), (o = n.lt.get(t)) && (o.forEach(function (n) { return n(t); }), n.lt.delete(t));
        }
        catch (e) {
            n.kn(e, 4, t);
        }
    ...
    } S(w, t, f); }); }, Cn: !1, wn: !1, st: !1, An: l, Mn: new WeakMap, K: new WeakMap, Nn: new WeakMap, ot: new WeakMap, vt: new WeakMap, ct: new WeakMap, _n: new WeakMap, jn: new WeakMap, gn: new WeakMap, mn: new WeakMap, bn: new WeakMap, lt: new WeakMap, Pn: new WeakMap, On: new WeakMap, Sn: new WeakMap, yn: new Set, Rn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, t.enableListener = function (n, t, e, r, i) { return function o(n, t, e, r, i, u) { if (t) {
    ...
    if (c && c.sn)
        if (r) {
            ...
            n.Z.cn(f, e, 1);
} }(w, n, t, e, r, i); }, w.xn = t.emit = function (n, e, r) { return h.et(n, t.eventNameFn ? t.eventNameFn(e) : e, r); }, d.h = e, d.Context = t, d.onReady = function () { return new Promise(function (n) { return w.queue.write(function () { return w.yn.size ? w.Rn.push(n) : n(); }); }); }, w.render = function (n, t) { var e, r, i, o, u, f, c, a = function (i, l, p, d, h, y, b, w, m) { if (w = l.vchildren[p], e || (o = !0, "slot" === w.vtag && (r && t.En(d, r + "-s"), w.vchildren ? w.pt = !0 : w.dt = !0)), v(w.vtext))
    w.i = t.Hn(w.vtext);
else if (w.dt)
    w.i = t.Hn("");
else {
    if (y = w.i = M || "svg" === w.vtag ? t.Fn("http://www.w3.org/2000/svg", w.vtag) : t.V(w.pt ? "slot-fb" : w.vtag), n.ft(y) && n.ct.delete(c), M = "svg" === w.vtag || "foreignObject" !== w.vtag && M, g(n, null, w, M), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), w.vchildren)
        for (h = 0; h < w.vchildren.length; ++h)
            (b = a(i, w, h, y)) && t.Bn(y, b);
    "svg" === w.vtag && (M = !1);
} return w.i["s-hn"] = f, (w.pt || w.dt) && (w.i["s-sr"] = !0, w.i["s-cr"] = u, w.i["s-sn"] = w.vname || "", (m = i && i.vchildren && i.vchildren[p]) && m.vtag === w.vtag && i.i && s(i.i)), w.i; }, s = function (e, r, i, u) { n.st = !0; var c = t.In(e); for (i = c.length - 1; i >= 0; i--)
    ...
    if (null == M)
        ...
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Gn(M.i)), b(M, A), t.X(n, M.i, t.Qn(j.i)), M = e[++w], A = i[--k];
    else if (d(j, $))
        "slot" !== M.vtag && "slot" !== A.vtag || s(t.Gn(j.i)), b(j, $), t.X(n, j.i, M.i), j = e[--g], $ = i[++m];
    else {
    ...
    } w > g ? l(n, null == i[k + 1] ? null : i[k + 1].i, r, i, m, k) : m > k && p(e, w, g); }(o, u, r, f) : v(f) ? (v(e.vtext) && t.Jn(o, ""), l(o, null, r, f, 0, f.length - 1)) : v(u) && p(u, 0, u.length - 1)), M && "svg" === r.vtag && (M = !1); }, w = function (n, e, r, i, o, u, f, c) { for (i = 0, o = (r = t.In(n)).length; i < o; i++)
    if (e = r[i], 1 === t.Dn(e)) {
        if (e["s-sr"])
    ...
    1 === t.Dn(r) && j(r);
} }; return function (a, s, l, v, p, d, h, y, g, M, k, $) { if (c = a, f = t.Zn(c), u = c["s-cr"], e = v, r = c["s-sc"], o = i = !1, b(s, l), o) {
    ...
    n.st = !1;
} return i && w(l.i), m.length = 0, l; }; }(w, h), y["s-ld"] = [], y["s-rn"] = !0, y["s-init"] = function () { w.ct.set(y, d.loaded = w.wn = !0), h.et(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
    ...
    for (o = 0; o < i.length; o++)
        i[o][1](null);
    i.length = 0;
} }(w, d, r, r["s-apps"], r["s-cr"]), d.initialized = !0, w; }, F = {}, H = !1;
